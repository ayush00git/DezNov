...
function Auth({ className = "" }) {
  ...
  return (
    <div className={`flex flex-wrap border-2 border-[#849ADE] text-white w-fit py-4 px-6 rounded-full gap-5 bg-[rgba(49,61,94,0.9)] ${className}`}>
      {/* Login Button */}
      <div
        className={`w-[118px] flex items-center gap-[7px] cursor-pointer shadow-[5px_5px_8px_#00000040] px-[18px] py-[5px] h-[38px] rounded-[23px] relative ${
      ...
      {/* Signup Button */}
      <div
        className={`border border-solid w-[129px] cursor-pointer flex items-center gap-1.5 shadow-[5px_5px_8px_#00000040] px-[18px] py-[5px] h-[38px] rounded-[23px] relative ${
      ...
      {/* Explore Button */}
      <div
        className={`border border-solid w-[129px] cursor-pointer flex items-center gap-1.5 shadow-[4px_4px_8px_#00000040] px-[17px] py-[5px] h-[38px] rounded-[23px] relative ${
